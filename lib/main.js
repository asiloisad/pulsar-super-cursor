...
module.exports = {
  ...
  activate() {
    ...
    this.disposables.add(
      atom.commands.add("atom-text-editor", {
        "super-cursor:power-global": () => {
          this.powerGlobal();
        },
        "super-cursor:power-editor": (e) => {
          this.powerEditor(e);
        },
  ...
  power(editor, state) {
    ...
    if (editor.cursorPower) {
      editor.element.classList.add("super-cursor");
    } else {
      editor.element.classList.remove("super-cursor");
    }
  },
  ...
  activateStatusBar() {
    ...
    this.tooltipDisposable = atom.tooltips.add(this.statusBarItem, {
      title: () => this.global ? "Power mode: global on" : "Power mode: global off",
      keyBindingCommand: "super-cursor:power-global",
  ...
  createStatusBarItem() {
    ...
    element.classList.add("super-cursor-status", "inline-block");
